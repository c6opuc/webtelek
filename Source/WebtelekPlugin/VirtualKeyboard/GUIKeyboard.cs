...
namespace MediaPortal.GUI.WebTelek
{
  ...
  /// </summary>
  public abstract class GUIKeyboardRU : GUIControl
  {
    ...
    private bool _useSmsStyleTextInsertion = false;
    ...
    public class Key
    {
      ...
      public Key(Xkey key, int iwidth, GUIKeyboardRU kb)
      {
        xKey = key;
        dwWidth = iwidth;
...
//            break;
    ...
    public GUIKeyboardRU(int dwParentID)
      : base(dwParentID) {}
    ...
    public GUIKeyboardRU(int dwParentID, int dwControlId, int dwPosX, int dwPosY, int dwWidth, int dwHeight)
    ...
    protected virtual void InitBoard()
    {
      ...
      {
        keyRow.Add(new Key(Xkey.XK_RUSSIAN, _modeKeyWidth, this));
      }
      if (!_useSmsStyleTextInsertion)
      {
      ...
      if (_useSearchLayout)
      {
        keyRow.Add(new Key(Xkey.XK_RUSSIAN, _modeKeyWidth, this)); // Searchkeyboard
      }
      else
      {
      ...
      // À - Ç
      keyRow.Add(new Key(Xkey.XK_RUS_Aa, _keyWidth, this)); // À
      keyRow.Add(new Key(Xkey.XK_RUS_Be, _keyWidth, this)); // Á
      keyRow.Add(new Key(Xkey.XK_RUS_Ve, _keyWidth, this)); // Â
      keyRow.Add(new Key(Xkey.XK_RUS_Ge, _keyWidth, this)); // Ã
      keyRow.Add(new Key(Xkey.XK_RUS_De, _keyWidth, this)); // Ä
      keyRow.Add(new Key(Xkey.XK_RUS_Ee, _keyWidth, this)); // Å
      keyRow.Add(new Key(Xkey.XK_RUS_Je, _keyWidth, this)); // Æ
      keyRow.Add(new Key(Xkey.XK_RUS_Ze, _keyWidth, this)); // Ç
      keyRow.Add(new Key(Xkey.XK_RUS_Ii, _keyWidth, this)); // È
      keyRow.Add(new Key(Xkey.XK_RUS_Ji, _keyWidth, this)); // É
      ...
      // È - Ï
      keyRow.Add(new Key(Xkey.XK_RUS_Ka, _keyWidth, this)); // Ê
      keyRow.Add(new Key(Xkey.XK_RUS_Le, _keyWidth, this)); // Ë
      keyRow.Add(new Key(Xkey.XK_RUS_Me, _keyWidth, this)); // Ì
      keyRow.Add(new Key(Xkey.XK_RUS_Ne, _keyWidth, this)); // Í
      keyRow.Add(new Key(Xkey.XK_RUS_Oo, _keyWidth, this)); // Î
      keyRow.Add(new Key(Xkey.XK_RUS_Pe, _keyWidth, this)); // Ï
      keyRow.Add(new Key(Xkey.XK_RUS_Re, _keyWidth, this)); // Ð
      keyRow.Add(new Key(Xkey.XK_RUS_Se, _keyWidth, this)); // Ñ
      keyRow.Add(new Key(Xkey.XK_RUS_Te, _keyWidth, this)); // Ò
      keyRow.Add(new Key(Xkey.XK_RUS_Uu, _keyWidth, this)); // Ó
      ...
      // Ð - ×
      keyRow.Add(new Key(Xkey.XK_RUS_Fe, _keyWidth, this)); // Ô
      keyRow.Add(new Key(Xkey.XK_RUS_Ha, _keyWidth, this)); // Õ
      keyRow.Add(new Key(Xkey.XK_RUS_Ce, _keyWidth, this)); // Ö
      keyRow.Add(new Key(Xkey.XK_RUS_Ch, _keyWidth, this)); // ×
      keyRow.Add(new Key(Xkey.XK_RUS_Sh, _keyWidth, this)); // Ø
      keyRow.Add(new Key(Xkey.XK_RUS_Sc, _keyWidth, this)); // Ù
      keyRow.Add(new Key(Xkey.XK_RUS_TZ, _keyWidth, this)); // Ú
      keyRow.Add(new Key(Xkey.XK_RUS_YY, _keyWidth, this)); // Û
      keyRow.Add(new Key(Xkey.XK_RUS_MZ, _keyWidth, this)); // Ü
      keyRow.Add(new Key(Xkey.XK_RUS_EE, _keyWidth, this)); // Ý
      ...
      keyRow.Add(new Key(Xkey.XK_RUS_Yu, _keyWidth, this)); // Þ
      keyRow.Add(new Key(Xkey.XK_RUS_Ya, _keyWidth, this)); // ß
      keyRow.Add(new Key(Xkey.XK_RUS_I, _keyWidth, this));  // ²
      keyRow.Add(new Key(Xkey.XK_RUS_Yi, _keyWidth, this)); // ¯
      keyRow.Add(new Key(Xkey.XK_RUS_Ie, _keyWidth, this)); // ª
      keyRow.Add(new Key(Xkey.XK_RUS_Jo, _keyWidth, this)); // ¨
      keyRow.Add(new Key(Xkey.XK_RUS_Gh, _keyWidth, this)); // ¥
      ...
      keyRow.Add(new Key(Xkey.XK_BACKSPACE, (_keyWidth * 3) + (_keyHorizontalSpacing * 3), this));
      keyBoard.Add(keyRow);
      ...
      do
      {
        ...
        switch (_currentRow)
        {
          ...
          case 3:
            ...
            if (_currentKeyboard == KeyboardTypes.TYPE_RUSSIAN && _currentKey > 8)
            {
              _currentKey = 8;
            }
            break;
