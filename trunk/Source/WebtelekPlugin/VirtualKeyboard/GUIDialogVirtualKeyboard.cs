...
{
  public abstract class VirtualKeyboardRU : GUIWindow, IRenderLayer
  {
    [SkinControl(1)] protected GUIKeyboardRU _keyboard = null;
    ...
    public override bool Init()
    {
      ...
      _keyboard.TextChanged += new GUIKeyboardRU.TextChangedEventHandler(keyboard_TextChanged);
      return true;
    }
  ...
  public class StandardKeyboard : VirtualKeyboardRU
  {

      public StandardKeyboard() : base()
    {
        GUIControlFactory.RegisterControl("standardKeyboardRU", typeof(GUIStandardKeyboardRU));

      if (Load(GUIGraphicsContext.Skin + @"\stdKeyboardRU.xml"))
      {
          GetID = MediaPortal.GUI.WebTelek.WebTelek.VirtualKeyboardID;
        _keyboard.InitializeInstance();
      }
    }
