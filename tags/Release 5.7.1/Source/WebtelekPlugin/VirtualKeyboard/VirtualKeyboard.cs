...
namespace MediaPortal.GUI.WebTelek
{
  ...
  /// 
  /// </summary>
  public class VirtualKeyboardRU : GUIWindow, IRenderLayer
  {
    #region constants
    ...
    public VirtualKeyboardRU()
    {
      GetID = WebTelek.VirtualKeyboardID;
    ...
    void InitBoard()
    {
      ...
      if (_useSearchLayout)
        ...
        keyRow.Add(new Key(Xkey.XK_RUSSIAN, MODEKEY_WIDTH));
      ...
      if (_useSearchLayout)
        keyRow.Add(new Key(Xkey.XK_RUSSIAN, MODEKEY_WIDTH));   // Searchkeyboard
      else
      ...
      keyRow.Add(new Key(Xkey.XK_OK, MODEKEY_WIDTH));
        // À - Ç
      keyRow.Add(new Key(Xkey.XK_RUS_Aa)); // À
      keyRow.Add(new Key(Xkey.XK_RUS_Be)); // Á
      keyRow.Add(new Key(Xkey.XK_RUS_Ve)); // Â
      keyRow.Add(new Key(Xkey.XK_RUS_Ge)); // Ã
      keyRow.Add(new Key(Xkey.XK_RUS_De)); // Ä
      keyRow.Add(new Key(Xkey.XK_RUS_Ee)); // Å
      keyRow.Add(new Key(Xkey.XK_RUS_Je)); // Æ
      keyRow.Add(new Key(Xkey.XK_RUS_Ze)); // Ç
      keyRow.Add(new Key(Xkey.XK_RUS_Ii)); // È
      keyRow.Add(new Key(Xkey.XK_RUS_Ji)); // É
      ...
      if (_useSearchLayout)
        ...
        // È - Ï
      keyRow.Add(new Key(Xkey.XK_RUS_Ka)); // Ê
      keyRow.Add(new Key(Xkey.XK_RUS_Le)); // Ë
      keyRow.Add(new Key(Xkey.XK_RUS_Me)); // Ì
      keyRow.Add(new Key(Xkey.XK_RUS_Ne)); // Í
      keyRow.Add(new Key(Xkey.XK_RUS_Oo)); // Î
      keyRow.Add(new Key(Xkey.XK_RUS_Pe)); // Ï
      keyRow.Add(new Key(Xkey.XK_RUS_Re)); // Ð
      keyRow.Add(new Key(Xkey.XK_RUS_Se)); // Ñ
      keyRow.Add(new Key(Xkey.XK_RUS_Te)); // Ò
      keyRow.Add(new Key(Xkey.XK_RUS_Uu)); // Ó
      ...
      // Ð - ×
      keyRow.Add(new Key(Xkey.XK_RUS_Fe)); // Ô
      keyRow.Add(new Key(Xkey.XK_RUS_Ha)); // Õ
      keyRow.Add(new Key(Xkey.XK_RUS_Ce)); // Ö
      keyRow.Add(new Key(Xkey.XK_RUS_Ch)); // ×
      keyRow.Add(new Key(Xkey.XK_RUS_Sh)); // Ø
      keyRow.Add(new Key(Xkey.XK_RUS_Sc)); // Ù
      keyRow.Add(new Key(Xkey.XK_RUS_TZ)); // Ú
      keyRow.Add(new Key(Xkey.XK_RUS_YY)); // Û
      keyRow.Add(new Key(Xkey.XK_RUS_MZ)); // Ü
      keyRow.Add(new Key(Xkey.XK_RUS_EE)); // Ý
      ...
      keyRow.Add(new Key(Xkey.XK_RUS_Yu)); // Þ
      keyRow.Add(new Key(Xkey.XK_RUS_Ya)); // ß
